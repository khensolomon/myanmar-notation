...
var Notation = (function () {
    function Notation(q) {
        ...
        if (this.clean(q)) {
            ...
            if (this.clean(q.split('').map(function (k) { return configuration_1.configuration.digit.indexOf(k); }).filter(function (e) { return e >= 0; }).join('')))

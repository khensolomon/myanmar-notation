 ...
 * convert to Burmese
 */
export const keepBurmese = str => str.replace(/[0-9]/g,i=>$.numeral[parseInt(i)].digit);

/**
 * @param {string} str
 * convert from Burmese
 */
export const turnBurmese = str => str.split('').map(
  i => digitBurmese.includes(i)?$.numeral.findIndex(
    e => e.digit == i
  ):i
).join('');
